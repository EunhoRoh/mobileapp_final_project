...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final imageWidget = Image.asset('assets/'+product.id.toString()+'.jpg'
      //product.assetName,
      ...
      Column(
            ...
            children: [
              ...
              ?Row(children:[Icon(Icons.star), Icon(Icons.star), Icon(Icons.star), Icon(Icons.star)]):
                          product.star == 5
              ?Row(children:[Icon(Icons.star), Icon(Icons.star), Icon(Icons.star), Icon(Icons.star), Icon(Icons.star)])
                             */
              Text(
                product.name,
